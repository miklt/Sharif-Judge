	...
	public function index()
	{
		...
		if ($this->form_validation->run()) {
			...
			$result = $this->db->insert_batch('settings', array(
				array('shj_key' => 'timezone',               'shj_value' => $_ENV["APP_TIMEZONE"]),
				array('shj_key' => 'tester_path',            'shj_value' => $_ENV["APP_TESTER_PATH"]),
				array('shj_key' => 'assignments_root',       'shj_value' => $_ENV["APP_ASSIGNMENTS_ROOT"]),
