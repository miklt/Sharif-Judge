...
[PCS Sharif Judge](https://github.com/PCS-Poli-USP/Sharif-Judge) is a free and open source online judge for C, C++, Java and
Python programming courses. This is a fork of [Sharif Judge](https://github.com/mjnaderi/Sharif-Judge/)
...
## Installation
  ...
  1. Download the latest release from [download page](https://github.com/PCS-Poli-USP/Sharif-Judge/releases) and unpack downloaded file in your public html directory.
  ...
  9. **[IMPORTANT]** [Secure Sharif Judge](https://github.com/PCS-Poli-USP/Sharif-Judge/blob/docs/v1.5/security.md)

## After Installation

  * Read the [documentation](https://github.com/PCS-Poli-USP/Sharif-Judge/tree/docs)
